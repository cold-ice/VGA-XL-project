...
// il parametro add � l'indirizzo del registro da settare; il parametro val � il valore da scrivere nel registro
void setup_accelerometro(char add,char val)
{
...
// i parametri add1 e add2 sono gli indirizzi dei registri di output (su 8 bit) relativi alla singola componente di accelerazione e velocit�
int16_t mult_read (char add1,char add2)
{
...
void SerialSend (void)
{
        ...
        // divido la variabile su 16 bit in due da 8 poich� la seriale invia pacchetti da 8 bit di dato
